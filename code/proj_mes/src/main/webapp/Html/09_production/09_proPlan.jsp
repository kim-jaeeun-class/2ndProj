...
<html lang="en">
    ...
    <body class="bg-gray-100 text-gray-800" page="pro-plan">
        ...
        <div class="sidenwrap">
            <div class="side">
                <!-- a 링크 나중에 달기 -->
                <a href="09_proPlan.jsp"><div class="side-menu">생산 계획</div></a>
                <a href="09_work_order.jsp"><div class="side-menu">작업 지시서</div></a>
            </div>
            <div class="wrap">
                ...
                <div class="wrap-select">
                    <form class="date-filter">
                        <div class="select-con">
                            <div class="select-title">계획 등록일</div>
                        ...
                        <div class="select-con">
                            ...
                            <select name="align" class="select select-drop">
                                <option value="upDate" selected="selected">등록일(오름차순)</option>
                                <option value="downDate">등록일(내림차순)</option>
                            </select>
                        </div>
                        <div class="filter-submit">
                            <button type="button" class="button" name="search">조회</button>
                        </div>
                    </form>
                </div>
                <!-- 테이블 영역 -->
            ...
            <button class="close-btn">✕</button>
                ...
                <form class="wrap-table panel-table">
                    ...
                    <div class="wrap-tableBtn">
                        ...
                        <input type="button" name="detaile-delete" class="button delete" value="삭제">
                    </div>
                </form>
            </div>
        </div>
