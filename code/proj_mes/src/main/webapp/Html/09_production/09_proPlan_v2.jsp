...
<body class="bg-gray-100 text-gray-800" page="pro-plan">
  ...
  <div class="sidenwrap">
    ...
    <div class="wrap">
      <div class="wrap-title">생산 계획</div>
  ...
  <div class="panel" id="panel-down">
    ...
    <form class="wrap-table panel-table" action="proplan" method="post">
      ...
      <table class="modal-table">
        <tr><td class="modal-table-title">생산계획번호</td><td class="modal-table-con">#생산계획번호</td></tr>
        <tr><td class="modal-table-title">제품번호</td><td class="modal-table-con">#품번</td></tr>
        <tr><td class="modal-table-title">계획 수량</td><td class="modal-table-con">#수량</td></tr>
        <tr><td class="modal-table-title">계획 기간</td><td class="modal-table-con">#기간</td></tr>
        <tr><td class="modal-table-title">진행률</td><td class="modal-table-con">#수치(%)</td></tr>
        <tr><td class="modal-table-title">달성률</td><td class="modal-table-con">#수치(%)</td></tr>
        <tr><td class="modal-table-title">불량률</td><td class="modal-table-con">#수치(%)</td></tr>
        <tr><td class="modal-table-title">비고</td><td class="modal-table-con">#비고(공란 가능)</td></tr>
      </table>
  ...
  <script>
    // --- 드롭다운 초기화: 템플릿 삽입 후에만 바인딩 ---
    function initUserMenu() {
      const myIconBtn = document.getElementById('myIconBtn');
      const userMenu  = document.getElementById('userMenu');
      if (!myIconBtn || !userMenu) return; // 템플릿에 해당 id가 없으면 종료
    ...
    (async function () {
      try {
        ...
        // 템플릿이 DOM에 붙은 이후에만 바인딩
        initUserMenu();
      }
    })();

    // --- (옵션) 체크박스/삭제 로직: 요소 없으면 스킵 ---
    (function () {
